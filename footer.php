													  ...
													  <div class="ev-footer-cave-informations-infos" itemscope itemtype="http://schema.org/LocalBusiness">
															...
															<div class="cave-info" itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">
																...
																<p class="address">
																	...
																	<span itemprop="postalCode"><?php echo _x('34360', 'location', 'wine-space-shopkeeper');?></span>, <span itemprop="addressLocality"><?php echo _x('Saint-Chinian, France', 'location', 'wine-space-shopkeeper');?></span></span>
																</address>
														...
														<div class="ev-footer-cave-informations-image">
															<img src="https://www.zupimages.net/up/21/27/5h3v.png"/>
														</div>
													</div>
