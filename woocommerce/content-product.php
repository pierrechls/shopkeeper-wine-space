		...
		<div class="product_thumbnail_wrapper <?php if ( !$product->is_in_stock() ) : ?>outofstock<?php endif; ?>">
			...
			<?php if ( (isset($shopkeeper_theme_options['catalog_mode'])) && ($shopkeeper_theme_options['catalog_mode'] == 0) ) : ?>
				...
				<?php
					...
					if( $medailles ):
				?>
						<div class="ev-content-product-medailles">
							<?php foreach( $medailles as $medaille ): ?>
								<?php if( $medaille === 'bio' ) { ?> <div class="ev-tooltip"><img src="<?php echo get_stylesheet_directory_uri() . '/images/products/product-icon-agriculture-biologique.png'; ?>" /> <span class="tooltiptext"><?php _e('bio', 'wine-space-shopkeeper');?></span></div> <?php } ?>
								<?php if( $medaille === 'biodynamie' ) { ?> <div class="ev-tooltip"><img src="<?php echo get_stylesheet_directory_uri() . '/images/products/product-icon-biodynamie.png'; ?>" /> <span class="tooltiptext"><?php _e('biodynamie', 'wine-space-shopkeeper');?></span></div> <?php } ?>
								<?php if( $medaille === 'conversion-agriculture-biologique' ) { ?> <div class="ev-tooltip"><img src="<?php echo get_stylesheet_directory_uri() . '/images/products/product-icon-conversion-agriculture-biologique.png'; ?>" /> <span class="tooltiptext"><?php _e('conversion-agriculture-biologique', 'wine-space-shopkeeper');?></span></div><?php } ?>
								<?php if( $medaille === 'elevage-amphore' ) { ?> <div class="ev-tooltip"><img src="<?php echo get_stylesheet_directory_uri() . '/images/products/product-icon-elevage-amphore.png'; ?>" /> <span class="tooltiptext"><?php _e('elevage-amphore', 'wine-space-shopkeeper');?></span></div> <?php } ?>
								<?php if( $medaille === 'haute-valeur-environnementale' ) { ?> <div class="ev-tooltip"><img src="<?php echo get_stylesheet_directory_uri() . '/images/products/product-icon-haute-valeur-environnementale.png'; ?>" /> <span class="tooltiptext"><?php _e('haute-valeur-environnementale', 'wine-space-shopkeeper');?></span></div><?php } ?>
								<?php if( $medaille === 'prix-propiete' ) { ?> <div class="ev-tooltip"><img src="<?php echo get_stylesheet_directory_uri() . '/images/products/product-icon-prix-propriete.png'; ?>" /> <span class="tooltiptext"><?php _e('prix-propriete', 'wine-space-shopkeeper');?></span></div> <?php } ?>
								<?php if( $medaille === 'sans-sulfite-ajoute' ) { ?> <div class="ev-tooltip"><img src="<?php echo get_stylesheet_directory_uri() . '/images/products/product-icon-sans-sulfite-ajoute.png'; ?>" /> <span class="tooltiptext"><?php _e('sans-sulfite-ajoute', 'wine-space-shopkeeper');?></span></div><?php } ?>
								<?php if( $medaille === 'vin-nature' ) { ?> <div class="ev-tooltip"><img src="<?php echo get_stylesheet_directory_uri() . '/images/products/product-icon-vin-nature.png'; ?>" /> <span class="tooltiptext"><?php _e('vin-nature', 'wine-space-shopkeeper');?></span></div> <?php } ?>
							<?php endforeach; ?>
						</div>
				<?php
					endif;
